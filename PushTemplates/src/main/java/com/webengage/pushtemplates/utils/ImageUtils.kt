...
class ImageUtils {
    ...
    suspend fun getBitmapArrayList(
        ...
        } else if(pushNotificationData.style == WebEngageConstant.STYLE.CAROUSEL_V1) {
            for (i in pushNotificationData.carouselV1Data.callToActions){
                urlList.add(i.imageURL)
            }
        }
